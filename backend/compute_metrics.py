...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Compute validation metrics for trained models"
    )
    ...
    parser.add_argument(
        "--models_dir", type=str, default="../models", help="Path to models directory"
    )

    parser.add_argument(
        "--output",
        type=str,
        default="../models/model_metrics.json",
    ...
    parser.add_argument(
        "--models",
        nargs="+",
        default=["baseline", "efficientnet", "mobilenet", "hybrid"],
    ...
    if len(all_metrics) > 0:
        ...
        all_metrics["ensemble"] = {
            ...
            "inference_time_ms": sum(
                m["inference_time_ms"] for m in all_metrics.values()
            )
            / len(all_metrics),
            ...
            "validation_samples": all_metrics[list(all_metrics.keys())[0]][
                "validation_samples"
            ],
        }
